...
export type SideChatLocaleKey =
  ...
  | 'drawer.model' | 'drawer.modelNextTurn'
  | 'drawer.jumpTitle' | 'drawer.jumpTree' | 'drawer.jumpProject'
...
export const en: Record<SideChatLocaleKey, string> = {
  ...
  'drawer.model': 'Model', 'drawer.modelNextTurn': 'Takes effect on the next turn',
  'drawer.jumpTitle': 'Jump to another btw',
  'drawer.jumpTree': 'This session tree', 'drawer.jumpProject': 'Project — all',
  'drawer.jumpLoading': 'Loading…', 'drawer.jumpEmpty': 'No other side conversations yet.',
  'drawer.jumpCurrent': 'current', 'drawer.jumpRunning': 'running',
  'drawer.jumpJustNow': 'just now', 'drawer.jumpMinutesSuffix': 'm ago',
...
export const zh: Record<SideChatLocaleKey, string> = {
  ...
  'drawer.model': '模型', 'drawer.modelNextTurn': '下一轮生效',
  'drawer.jumpTitle': '跳转到其他 btw',
  'drawer.jumpTree': '当前会话树', 'drawer.jumpProject': '项目全部',
  'drawer.jumpLoading': '加载中…', 'drawer.jumpEmpty': '还没有其他侧聊。',
  'drawer.jumpCurrent': '当前', 'drawer.jumpRunning': '运行中',
  'drawer.jumpJustNow': '刚刚', 'drawer.jumpMinutesSuffix': ' 分钟前',
