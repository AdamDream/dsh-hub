...
const BASE_DIR = "/home/CNS2026495165/dsh/.workspace/deploy-workerspace/base";
const basePkg = JSON.parse(readFileSync(join(BASE_DIR, "patch", "dsh-workspace-enhancement-0.1.2-rc2", "package.json"), "utf8"));
