  ...
  readonly model: {
    readonly services: readonly [{
      ...
      readonly members: readonly [{
        ...
        readonly kind: "method";
        readonly name: "readImage";
        readonly signature: "readImage(request: ReadSideChatImageRequest): Promise<ReadSideChatImageResult>";
        readonly summary: "Read one attached image back for display.";
        readonly jsDoc: "/** Read one admitted image back for display (R1-10 thumbnails). */";
      }, {
        readonly kind: "method";
        readonly name: "listTree";
        readonly signature: "listTree(request: ListSideChatTreeRequest): Promise<ListSideChatTreeResult>";
        readonly summary: "Enumerate side conversations under one session tree.";
        readonly jsDoc: "/** Enumerate side conversations under one session tree (R0-3). */";
      }, {
        readonly kind: "method";
        readonly name: "listProject";
        readonly signature: "listProject(request: ListSideChatProjectRequest): Promise<ListSideChatProjectResult>";
        readonly summary: "Enumerate side conversations grouped by the parent working directory.";
        readonly jsDoc: "/** Enumerate side conversations grouped by the parent working directory (R0-4). */";
      }];
