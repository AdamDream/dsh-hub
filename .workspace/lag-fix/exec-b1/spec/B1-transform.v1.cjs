/* ============================================================================
 * ⚠️ 本文件是 `patches/B1-transform.cjs`（**v1 规格**）的**只读副本**，用于落地脚本自证：
 *     `applyServerFilter_v1(pre_image)` 必须与**现行部署**逐字节相同（审计 §0-E2 不变量）。
 *    provenance: `.workspace/lag-fix/patches/B1-transform.cjs`（sha256 0f3a66767874841b936aa80c5236962001ed4a89cf43e6b39b222e6505ace1a8）
 *    exec-b1 的权威规格是 `exec-b1/B1-transform.v2.cjs`（v2 = v1 + 审计 §3.2 的 T1–T4 四处改动）。
 *    **不要**把本副本当作可部署规格，也**不要**回写 `patches/`（本体由主 agent 与 deployed 一起替换）。
 * ========================================================================== */
'use strict';
/**
