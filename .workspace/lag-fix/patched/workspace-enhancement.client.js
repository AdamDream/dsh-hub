window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\ZCodeProject\dsh-workspace-enhancement\src\client\flow.module.css.mjs
		const css$1 = ".Tpxs2G_overlay{--dshssh-accent:var(--color-primary,var(--accent,var(--primary,#4a6cf7)));--dshssh-accent-fg:#fff;--dshssh-surface:var(--color-bg-elevated,var(--background,var(--card,#17181c)));--dshssh-fg:var(--color-fg,var(--foreground,#e8e9ec));--dshssh-danger:var(--color-danger,var(--destructive,#e5534b));--dshssh-success:var(--color-success,var(--success,#3fb950));--dshssh-scrim:#090a0d94;--dshssh-shadow:0 24px 64px #00000080;--dshssh-surface-2:color-mix(in srgb, var(--dshssh-fg) 3%, var(--dshssh-surface));--dshssh-surface-3:color-mix(in srgb, var(--dshssh-fg) 7%, var(--dshssh-surface));--dshssh-surface-inset:color-mix(in srgb, black 10%, var(--dshssh-surface));--dshssh-line:color-mix(in srgb, var(--dshssh-fg) 8%, var(--dshssh-surface));--dshssh-border:color-mix(in srgb, var(--dshssh-fg) 14%, var(--dshssh-surface));--dshssh-border-strong:color-mix(in srgb, var(--dshssh-fg) 26%, var(--dshssh-surface));--dshssh-fg-muted:color-mix(in srgb, var(--dshssh-fg) 60%, var(--dshssh-surface));--dshssh-fg-subtle:color-mix(in srgb, var(--dshssh-fg) 38%, var(--dshssh-surface));--dshssh-accent-soft:color-mix(in srgb, var(--dshssh-accent) 13%, var(--dshssh-surface));--dshssh-danger-soft:color-mix(in srgb, var(--dshssh-danger) 12%, var(--dshssh-surface));--dshssh-success-soft:color-mix(in srgb, var(--dshssh-success) 12%, var(--dshssh-surface));--dshssh-danger-text:color-mix(in srgb, var(--dshssh-danger) 55%, var(--dshssh-fg));--dshssh-success-text:color-mix(in srgb, var(--dshssh-success) 45%, var(--dshssh-fg))}@media (prefers-color-scheme:light){.Tpxs2G_overlay{--dshssh-accent:var(--color-primary,var(--accent,var(--primary,#3b5bdb)));--dshssh-surface:var(--color-bg-elevated,var(--background,var(--card,#fff)));--dshssh-fg:var(--color-fg,var(--foreground,#21242a));--dshssh-danger:var(--color-danger,var(--destructive,#c9352f));--dshssh-success:var(--color-success,var(--success,#157f37));--dshssh-scrim:#0f111557;--dshssh-shadow:0 24px 64px #0f111533;--dshssh-surface-2:color-mix(in srgb, var(--dshssh-fg) 3%, var(--dshssh-surface));--dshssh-surface-3:color-mix(in srgb, var(--dshssh-fg) 7%, var(--dshssh-surface));--dshssh-surface-inset:color-mix(in srgb, black 6%, var(--dshssh-surface));--dshssh-line:color-mix(in srgb, var(--dshssh-fg) 8%, var(--dshssh-surface));--dshssh-border:color-mix(in srgb, var(--dshssh-fg) 14%, var(--dshssh-surface));--dshssh-border-strong:color-mix(in srgb, var(--dshssh-fg) 26%, var(--dshssh-surface));--dshssh-fg-muted:color-mix(in srgb, var(--dshssh-fg) 60%, var(--dshssh-surface));--dshssh-fg-subtle:color-mix(in srgb, var(--dshssh-fg) 38%, var(--dshssh-surface));--dshssh-accent-soft:color-mix(in srgb, var(--dshssh-accent) 11%, var(--dshssh-surface));--dshssh-danger-soft:color-mix(in srgb, var(--dshssh-danger) 10%, var(--dshssh-surface));--dshssh-success-soft:color-mix(in srgb, var(--dshssh-success) 10%, var(--dshssh-surface));--dshssh-danger-text:color-mix(in srgb, var(--dshssh-danger) 55%, var(--dshssh-fg));--dshssh-success-text:color-mix(in srgb, var(--dshssh-success) 45%, var(--dshssh-fg))}}.Tpxs2G_overlay{z-index:1000;background:var(--dshssh-scrim);font-family:var(--font-sans,ui-sans-serif, system-ui, -apple-system, \"Segoe UI\", Roboto, \"PingFang SC\", \"Microsoft YaHei\", sans-serif);justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;inset:0}.Tpxs2G_overlay button,.Tpxs2G_overlay input{font-family:inherit}.Tpxs2G_overlay :focus-visible{outline:2px solid var(--dshssh-accent);outline-offset:1px}.Tpxs2G_gap{flex:auto}.Tpxs2G_mono{font-family:var(--font-mono,ui-monospace, \"SF Mono\", \"Cascadia Code\", Consolas, monospace)}.Tpxs2G_spin{animation:.8s linear infinite Tpxs2G_dshssh-rotate}@keyframes Tpxs2G_dshssh-rotate{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.Tpxs2G_spin{animation:none}}.Tpxs2G_button{border:1px solid var(--dshssh-border);color:var(--dshssh-fg);cursor:pointer;white-space:nowrap;background:0 0;border-radius:7px;justify-content:center;align-items:center;gap:6px;padding:5px 13px;font-size:12.5px;font-weight:500;line-height:1.4;display:inline-flex}.Tpxs2G_button svg{flex:none}.Tpxs2G_button:hover:not(:disabled){background:var(--dshssh-surface-3);border-color:var(--dshssh-border-strong)}.Tpxs2G_primary{background:var(--dshssh-accent);border-color:var(--dshssh-accent);color:var(--dshssh-accent-fg)}.Tpxs2G_primary:hover:not(:disabled){background:color-mix(in srgb, var(--dshssh-accent) 85%, #fff);border-color:color-mix(in srgb, var(--dshssh-accent) 85%, #fff)}.Tpxs2G_danger{background:var(--dshssh-danger);border-color:var(--dshssh-danger);color:#fff}.Tpxs2G_danger:hover:not(:disabled){background:color-mix(in srgb, var(--dshssh-danger) 82%, #fff);border-color:color-mix(in srgb, var(--dshssh-danger) 82%, #fff)}.Tpxs2G_button:disabled{opacity:.5;cursor:default}.Tpxs2G_iconButton{width:28px;height:28px;color:var(--dshssh-fg-muted);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;justify-content:center;align-items:center;display:inline-flex}.Tpxs2G_iconButton:hover:not(:disabled){background:var(--dshssh-surface-3);color:var(--dshssh-fg)}.Tpxs2G_iconButton:disabled{opacity:.45;cursor:default}.Tpxs2G_dialog{background:var(--dshssh-surface);width:min(920px,100%);height:min(620px,100vh - 48px);color:var(--dshssh-fg);border:1px solid var(--dshssh-border);box-shadow:var(--dshssh-shadow);border-radius:12px;flex-direction:column;font-size:13px;display:flex;overflow:hidden}.Tpxs2G_header{align-items:center;gap:10px;padding:14px 16px 10px;display:flex}.Tpxs2G_headerText{flex:auto;min-width:0}.Tpxs2G_title{margin:0;font-size:15px;font-weight:600;line-height:1.35}.Tpxs2G_subtitle{color:var(--dshssh-fg-muted);text-overflow:ellipsis;white-space:nowrap;margin:2px 0 0;font-size:12px;overflow:hidden}.Tpxs2G_body{flex:auto;min-height:0;display:flex}.Tpxs2G_sidebar{border-right:1px solid var(--dshssh-line);background:var(--dshssh-surface-2);flex-direction:column;flex:none;width:268px;padding:10px;display:flex;overflow-y:auto}.Tpxs2G_main{flex-direction:column;flex:auto;min-width:0;display:flex}.Tpxs2G_sidebarSection{flex-direction:column;display:flex}.Tpxs2G_sidebarSection+.Tpxs2G_sidebarSection{border-top:1px solid var(--dshssh-line);margin-top:10px;padding-top:10px}.Tpxs2G_sidebarAdd{background:var(--dshssh-accent);width:30px;height:30px;color:var(--dshssh-accent-fg);cursor:pointer;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;margin-top:10px;margin-left:auto;padding:0;display:inline-flex;position:sticky;bottom:4px;box-shadow:0 4px 12px #00000047}.Tpxs2G_sidebarAdd:hover{filter:brightness(1.1)}.Tpxs2G_sidebarTitle{color:var(--dshssh-fg-subtle);letter-spacing:.08em;text-transform:uppercase;align-items:center;gap:6px;margin:0 0 4px;padding:0 2px;font-size:10.5px;font-weight:600;display:flex}.Tpxs2G_sidebarCount{background:var(--dshssh-surface-3);color:var(--dshssh-fg-muted);border-radius:8px;padding:0 6px;font-size:11px;font-weight:600;line-height:17px}.Tpxs2G_sideError{background:var(--dshssh-danger-soft);border:1px solid color-mix(in srgb, var(--dshssh-danger) 28%, transparent);border-radius:8px;flex-direction:column;align-items:flex-start;gap:6px;padding:8px 10px;display:flex}.Tpxs2G_sideErrorText{color:var(--dshssh-danger-text);overflow-wrap:anywhere;margin:0;font-size:12px}.Tpxs2G_sideEmpty{flex-direction:column;align-items:flex-start;gap:3px;padding:6px 2px 4px;display:flex}.Tpxs2G_sideEmptyIcon{color:var(--dshssh-fg-subtle);margin-bottom:2px}.Tpxs2G_sideEmptyTitle{color:var(--dshssh-fg);margin:0;font-size:12.5px;font-weight:600}.Tpxs2G_sideEmptyText{color:var(--dshssh-fg-muted);margin:0;font-size:12px;line-height:1.5}.Tpxs2G_hostWorking{color:var(--dshssh-fg-muted);align-items:center;gap:5px;font-size:12px;display:inline-flex}.Tpxs2G_hostSpinner{width:12px;height:12px;color:var(--dshssh-accent)}.Tpxs2G_hostErrorText{color:var(--dshssh-danger-text);overflow-wrap:anywhere;font-size:12px;line-height:1.45}.Tpxs2G_toolbar{border-top:1px solid var(--dshssh-line);border-bottom:1px solid var(--dshssh-line);background:var(--dshssh-surface-2);align-items:center;gap:8px;min-height:36px;padding:5px 16px;display:flex}.Tpxs2G_crumbs{flex-wrap:wrap;flex:auto;align-items:center;gap:2px;min-width:0;font-size:12px;display:flex}.Tpxs2G_crumb{color:var(--dshssh-accent);cursor:pointer;text-overflow:ellipsis;white-space:nowrap;background:0 0;border:none;border-radius:4px;max-width:22ch;padding:2px 5px;font-size:12px;overflow:hidden}.Tpxs2G_crumb:hover:not(:disabled){background:var(--dshssh-surface-3)}.Tpxs2G_crumb:disabled{color:var(--dshssh-fg-subtle);cursor:default}.Tpxs2G_crumbStep{align-items:center;display:inline-flex}.Tpxs2G_crumbSep{color:var(--dshssh-fg-subtle);padding:0 1px}.Tpxs2G_crumbCurrent{color:var(--dshssh-fg);text-overflow:ellipsis;white-space:nowrap;max-width:44ch;padding:2px 5px;font-weight:600;overflow:hidden}.Tpxs2G_toolbarActions{flex:none;align-items:center;gap:4px;display:flex}.Tpxs2G_toolButton{width:28px;height:28px;color:var(--dshssh-fg-muted);cursor:pointer;background:0 0;border:none;border-radius:6px;justify-content:center;align-items:center;display:inline-flex;position:relative}.Tpxs2G_toolButtonText{border:1px solid var(--dshssh-border);width:auto;color:var(--dshssh-fg);gap:5px;padding:0 9px;font-size:12px;font-weight:500}.Tpxs2G_toolButton:hover:not(:disabled):not(.Tpxs2G_toolButtonOn){background:var(--dshssh-surface-3);color:var(--dshssh-fg)}.Tpxs2G_toolButton:disabled{opacity:.45;cursor:default}.Tpxs2G_toolButtonOn{background:var(--dshssh-accent-soft);color:var(--dshssh-accent)}.Tpxs2G_countBadge{background:var(--dshssh-accent);min-width:14px;height:14px;color:var(--dshssh-accent-fg);text-align:center;border-radius:7px;padding:0 3px;font-size:10px;font-weight:600;line-height:14px;position:absolute;top:-3px;right:-5px}.Tpxs2G_browser{flex:auto;min-height:200px;padding:6px 10px 8px 8px;overflow-y:auto}.Tpxs2G_browserBusy .Tpxs2G_entryList{opacity:.55;pointer-events:none}.Tpxs2G_entryList{flex-direction:column;gap:1px;margin:0;padding:0;list-style:none;display:flex}.Tpxs2G_entry{width:100%;color:var(--dshssh-fg);text-align:left;cursor:pointer;background:0 0;border:none;border-radius:7px;align-items:center;gap:8px;padding:6px 10px;font-size:13px;display:flex}.Tpxs2G_entry:hover{background:var(--dshssh-surface-3)}.Tpxs2G_entryIcon{color:var(--dshssh-fg-muted);flex:none}.Tpxs2G_entryName{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}.Tpxs2G_entryHidden .Tpxs2G_entryName,.Tpxs2G_entryHidden .Tpxs2G_entryIcon{opacity:.65}.Tpxs2G_entryChevron{color:var(--dshssh-fg-subtle);opacity:0;flex:none;transition:opacity .12s}.Tpxs2G_entry:hover .Tpxs2G_entryChevron,.Tpxs2G_entry:focus-visible .Tpxs2G_entryChevron{opacity:1}.Tpxs2G_truncated{color:var(--dshssh-fg-subtle);margin:6px 4px 0;font-size:12px}.Tpxs2G_skeletons{flex-direction:column;gap:10px;padding:10px 6px;display:flex}.Tpxs2G_skeleton{background:var(--dshssh-surface-3);border-radius:6px;height:12px;animation:1.4s ease-in-out infinite Tpxs2G_dshssh-pulse}@keyframes Tpxs2G_dshssh-pulse{0%,to{opacity:.45}50%{opacity:.9}}@media (prefers-reduced-motion:reduce){.Tpxs2G_skeleton{opacity:.6;animation:none}}.Tpxs2G_errorPanel{background:var(--dshssh-danger-soft);border:1px solid color-mix(in srgb, var(--dshssh-danger) 28%, transparent);border-radius:8px;align-items:flex-start;gap:10px;margin:10px 6px;padding:10px 12px;display:flex}.Tpxs2G_errorIcon{color:var(--dshssh-danger-text);flex:none;margin-top:1px}.Tpxs2G_errorBody{flex:auto;min-width:0}.Tpxs2G_errorActions{flex-direction:column;flex:none;align-self:center;align-items:stretch;gap:6px;display:flex}.Tpxs2G_errorTitle{color:var(--dshssh-danger-text);margin:0;font-size:12.5px;font-weight:600}.Tpxs2G_errorText{color:var(--dshssh-fg-muted);overflow-wrap:anywhere;margin:2px 0 0;font-size:12px}.Tpxs2G_retryButton{border:1px solid var(--dshssh-border);background:var(--dshssh-surface);color:var(--dshssh-fg);cursor:pointer;border-radius:6px;flex:none;align-items:center;gap:5px;padding:3px 9px;font-size:12px;display:inline-flex}.Tpxs2G_retryButton:hover{background:var(--dshssh-surface-3)}.Tpxs2G_emptyState{text-align:center;flex-direction:column;align-items:center;gap:4px;margin:auto;padding:28px 16px;display:flex}.Tpxs2G_emptyIcon{color:var(--dshssh-fg-subtle);margin-bottom:4px}.Tpxs2G_emptyTitle{color:var(--dshssh-fg);margin:0;font-size:13px;font-weight:600}.Tpxs2G_emptyText{color:var(--dshssh-fg-muted);margin:0;font-size:12px}.Tpxs2G_connectionList{flex-direction:column;gap:2px;margin:0;padding:0;list-style:none;display:flex}.Tpxs2G_connectionItem{border-radius:8px;align-items:stretch;gap:2px;display:flex}.Tpxs2G_connectionStatus{flex:none;align-items:center;padding:0 2px;display:flex}.Tpxs2G_connectionItem:hover:not(.Tpxs2G_connectionItemActive){background:color-mix(in srgb, var(--dshssh-fg) 4%, transparent)}.Tpxs2G_connectionItemActive{background:var(--dshssh-accent-soft)}.Tpxs2G_connectionMain{min-width:0;color:var(--dshssh-fg);font-size:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:7px;flex:auto;align-items:center;gap:10px;padding:5px 9px;display:flex}.Tpxs2G_connectionIcon{color:var(--dshssh-fg-muted);flex:none}.Tpxs2G_connectionItemActive .Tpxs2G_connectionIcon{color:var(--dshssh-accent)}.Tpxs2G_connectionInfo{flex-direction:column;flex:auto;gap:1px;min-width:0;display:flex}.Tpxs2G_connectionLabel{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;overflow:hidden}.Tpxs2G_connectionDetail{color:var(--dshssh-fg-muted);align-items:center;gap:5px;min-width:0;font-size:11.5px;display:flex}.Tpxs2G_connectionEndpoint{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.Tpxs2G_badge{background:color-mix(in srgb, var(--dshssh-fg) 5%, transparent);height:15px;color:var(--dshssh-fg-subtle);border:none;border-radius:4px;flex:none;align-items:center;gap:3px;padding:0 5px;font-size:10.5px;font-weight:500;line-height:14px;display:inline-flex}.Tpxs2G_connectionItemActive .Tpxs2G_badge{background:color-mix(in srgb, var(--dshssh-surface) 55%, transparent)}.Tpxs2G_badge svg{width:11px;height:11px}.Tpxs2G_badgeAdded{background:var(--dshssh-success-soft);color:var(--dshssh-success-text)}.Tpxs2G_connectionRemove{width:30px;color:var(--dshssh-fg-subtle);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:7px;flex:none;justify-content:center;align-items:center;transition:opacity .12s;display:inline-flex}.Tpxs2G_connectionItem:hover .Tpxs2G_connectionRemove,.Tpxs2G_connectionRemove:focus-visible,.Tpxs2G_connectionItemActive .Tpxs2G_connectionRemove{opacity:1}.Tpxs2G_connectionRemove:hover{color:var(--dshssh-danger-text);background:var(--dshssh-danger-soft)}@media (hover:none){.Tpxs2G_connectionRemove{opacity:1}}.Tpxs2G_skeletonRow{align-items:center;gap:10px;padding:10px 6px;display:flex}.Tpxs2G_skeletonDot{background:var(--dshssh-surface-3);border-radius:5px;flex:none;width:16px;height:16px;animation:1.4s ease-in-out infinite Tpxs2G_dshssh-pulse}.Tpxs2G_skeletonLines{flex-direction:column;flex:auto;gap:6px;display:flex}.Tpxs2G_skeletonLine{background:var(--dshssh-surface-3);border-radius:5px;height:9px;animation:1.4s ease-in-out infinite Tpxs2G_dshssh-pulse}.Tpxs2G_footer{border-top:1px solid var(--dshssh-line);align-items:center;gap:8px;padding:12px 16px 14px;display:flex}.Tpxs2G_smallDialog,.Tpxs2G_form{background:var(--dshssh-surface);width:min(520px,100%);max-height:calc(100vh - 48px);color:var(--dshssh-fg);border:1px solid var(--dshssh-border);box-shadow:var(--dshssh-shadow);border-radius:12px;flex-direction:column;gap:12px;padding:16px 18px;font-size:13px;display:flex;overflow-y:auto}.Tpxs2G_form{width:min(560px,100%)}.Tpxs2G_formTitle{margin:0;font-size:14px;font-weight:600}.Tpxs2G_formSub{color:var(--dshssh-fg-muted);margin:2px 0 0;font-size:12px}.Tpxs2G_formHead{align-items:flex-start;gap:10px;display:flex}.Tpxs2G_formHeadText{flex:auto;min-width:0}.Tpxs2G_formGrid{flex-direction:column;gap:12px;display:flex}.Tpxs2G_formGrid>.Tpxs2G_field{flex:none}.Tpxs2G_rowFields{flex-wrap:wrap;gap:10px;display:flex}.Tpxs2G_field{flex-direction:column;flex:180px;gap:5px;min-width:0;display:flex}.Tpxs2G_fieldPort{flex:0 96px}.Tpxs2G_fieldLabel{color:var(--dshssh-fg-muted);font-size:12px;font-weight:500}.Tpxs2G_required{color:var(--dshssh-danger-text);margin-left:2px}.Tpxs2G_fieldGroup{flex-direction:column;gap:5px;display:flex}.Tpxs2G_input{box-sizing:border-box;background:var(--dshssh-surface-inset);border:1px solid var(--dshssh-border);width:100%;color:var(--dshssh-fg);border-radius:7px;outline:none;padding:7px 10px;font-size:13px}.Tpxs2G_input::placeholder{color:var(--dshssh-fg-subtle)}.Tpxs2G_input:focus{border-color:var(--dshssh-accent);box-shadow:0 0 0 3px var(--dshssh-accent-soft)}.Tpxs2G_input:disabled{opacity:.6}.Tpxs2G_inputError{border-color:var(--dshssh-danger)}.Tpxs2G_inputError:focus{border-color:var(--dshssh-danger);box-shadow:0 0 0 3px var(--dshssh-danger-soft)}.Tpxs2G_fieldError{color:var(--dshssh-danger-text);margin:0;font-size:11.5px}.Tpxs2G_fieldHint{color:var(--dshssh-fg-subtle);font-size:11.5px}.Tpxs2G_segment{border:1px solid var(--dshssh-line);background:var(--dshssh-surface-inset);border-radius:9px;gap:3px;width:fit-content;padding:3px;display:inline-flex}.Tpxs2G_segmentButton{color:var(--dshssh-fg-muted);cursor:pointer;background:0 0;border:none;border-radius:6px;align-items:center;gap:6px;padding:4px 14px;font-size:12.5px;font-weight:500;display:inline-flex}.Tpxs2G_segmentButton:hover:not(.Tpxs2G_segmentButtonOn):not(:disabled){color:var(--dshssh-fg)}.Tpxs2G_segmentButtonOn{background:var(--dshssh-surface-3);color:var(--dshssh-fg);box-shadow:inset 0 0 0 1px var(--dshssh-border-strong)}.Tpxs2G_segmentButtonOn svg{color:var(--dshssh-accent)}.Tpxs2G_segmentButton:disabled{opacity:.55;cursor:default}.Tpxs2G_feedback{overflow-wrap:anywhere;border-radius:7px;align-items:flex-start;gap:8px;padding:8px 11px;font-size:12.5px;line-height:1.45;display:flex}.Tpxs2G_feedback svg{flex:none;margin-top:1px}.Tpxs2G_feedbackInfo{background:var(--dshssh-surface-2);border:1px solid var(--dshssh-line);color:var(--dshssh-fg-muted)}.Tpxs2G_feedbackSuccess{background:var(--dshssh-success-soft);border:1px solid color-mix(in srgb, var(--dshssh-success) 26%, transparent);color:var(--dshssh-success-text)}.Tpxs2G_feedbackError{background:var(--dshssh-danger-soft);border:1px solid color-mix(in srgb, var(--dshssh-danger) 26%, transparent);color:var(--dshssh-danger-text)}.Tpxs2G_formActions{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.Tpxs2G_createIn{color:var(--dshssh-fg-muted);overflow-wrap:anywhere;margin:0;font-size:12px}.Tpxs2G_createPath{color:var(--dshssh-fg);font-size:11.5px}.Tpxs2G_confirmHead{align-items:flex-start;gap:12px;display:flex}.Tpxs2G_confirmIconWrap{background:var(--dshssh-danger-soft);width:34px;height:34px;color:var(--dshssh-danger-text);border-radius:9px;flex:none;justify-content:center;align-items:center;display:inline-flex}.Tpxs2G_confirmIconInfo{background:var(--dshssh-accent-soft);color:var(--dshssh-accent)}.Tpxs2G_confirmText{color:var(--dshssh-fg-muted);overflow-wrap:anywhere;margin:3px 0 0;font-size:12.5px;line-height:1.55}@media (width<=640px){.Tpxs2G_overlay{padding:12px}.Tpxs2G_dialog,.Tpxs2G_smallDialog,.Tpxs2G_form{max-height:calc(100vh - 24px)}.Tpxs2G_body{flex-direction:column}.Tpxs2G_sidebar{border-right:none;border-bottom:1px solid var(--dshssh-line);width:auto;max-height:38%}.Tpxs2G_main{min-height:0}.Tpxs2G_errorPanel{flex-wrap:wrap}.Tpxs2G_errorActions{flex-direction:row;align-self:flex-start}.Tpxs2G_toolbar,.Tpxs2G_footer{flex-wrap:wrap}}";
		...
		var flow_module_css_default = {
			"errorIcon": "Tpxs2G_errorIcon",
			"formHead": "Tpxs2G_formHead",
			"errorPanel": "Tpxs2G_errorPanel",
			"feedbackSuccess": "Tpxs2G_feedbackSuccess",
			"truncated": "Tpxs2G_truncated",
			"errorBody": "Tpxs2G_errorBody",
			"crumbCurrent": "Tpxs2G_crumbCurrent",
			"skeletonRow": "Tpxs2G_skeletonRow",
			"toolbarActions": "Tpxs2G_toolbarActions",
			"emptyIcon": "Tpxs2G_emptyIcon",
			"segmentButton": "Tpxs2G_segmentButton",
			"crumb": "Tpxs2G_crumb",
			"dialog": "Tpxs2G_dialog",
			"main": "Tpxs2G_main",
			"sidebarCount": "Tpxs2G_sidebarCount",
			"sideEmptyIcon": "Tpxs2G_sideEmptyIcon",
			"rowFields": "Tpxs2G_rowFields",
			"sideEmptyText": "Tpxs2G_sideEmptyText",
			"formTitle": "Tpxs2G_formTitle",
			"createIn": "Tpxs2G_createIn",
			"createPath": "Tpxs2G_createPath",
			"confirmIconInfo": "Tpxs2G_confirmIconInfo",
			"crumbSep": "Tpxs2G_crumbSep",
			"toolButton": "Tpxs2G_toolButton",
			"connectionInfo": "Tpxs2G_connectionInfo",
			"footer": "Tpxs2G_footer",
			"overlay": "Tpxs2G_overlay",
			"countBadge": "Tpxs2G_countBadge",
			"connectionStatus": "Tpxs2G_connectionStatus",
			"fieldPort": "Tpxs2G_fieldPort",
			"connectionEndpoint": "Tpxs2G_connectionEndpoint",
			"dshssh-pulse": "Tpxs2G_dshssh-pulse",
			"crumbs": "Tpxs2G_crumbs",
			"sidebarAdd": "Tpxs2G_sidebarAdd",
			"mono": "Tpxs2G_mono",
			"sidebarTitle": "Tpxs2G_sidebarTitle",
			"skeleton": "Tpxs2G_skeleton",
			"fieldGroup": "Tpxs2G_fieldGroup",
			"entryList": "Tpxs2G_entryList",
			"danger": "Tpxs2G_danger",
			"fieldHint": "Tpxs2G_fieldHint",
			"crumbStep": "Tpxs2G_crumbStep",
			"hostSpinner": "Tpxs2G_hostSpinner",
			"subtitle": "Tpxs2G_subtitle",
			"hostWorking": "Tpxs2G_hostWorking",
			"entry": "Tpxs2G_entry",
			"emptyState": "Tpxs2G_emptyState",
			"iconButton": "Tpxs2G_iconButton",
			"sideErrorText": "Tpxs2G_sideErrorText",
			"button": "Tpxs2G_button",
			"fieldLabel": "Tpxs2G_fieldLabel",
			"fieldError": "Tpxs2G_fieldError",
			"dshssh-rotate": "Tpxs2G_dshssh-rotate",
			"connectionItem": "Tpxs2G_connectionItem",
			"segmentButtonOn": "Tpxs2G_segmentButtonOn",
			"smallDialog": "Tpxs2G_smallDialog",
			"connectionItemActive": "Tpxs2G_connectionItemActive",
			"connectionIcon": "Tpxs2G_connectionIcon",
			"inputError": "Tpxs2G_inputError",
			"title": "Tpxs2G_title",
			"sidebar": "Tpxs2G_sidebar",
			"confirmText": "Tpxs2G_confirmText",
			"entryHidden": "Tpxs2G_entryHidden",
			"emptyTitle": "Tpxs2G_emptyTitle",
			"field": "Tpxs2G_field",
			"sidebarSection": "Tpxs2G_sidebarSection",
			"feedbackInfo": "Tpxs2G_feedbackInfo",
			"entryName": "Tpxs2G_entryName",
			"retryButton": "Tpxs2G_retryButton",
			"emptyText": "Tpxs2G_emptyText",
			"entryIcon": "Tpxs2G_entryIcon",
			"sideEmptyTitle": "Tpxs2G_sideEmptyTitle",
			"formHeadText": "Tpxs2G_formHeadText",
			"form": "Tpxs2G_form",
			"entryChevron": "Tpxs2G_entryChevron",
			"hostErrorText": "Tpxs2G_hostErrorText",
			"required": "Tpxs2G_required",
			"badgeAdded": "Tpxs2G_badgeAdded",
			"gap": "Tpxs2G_gap",
			"feedbackError": "Tpxs2G_feedbackError",
			"connectionMain": "Tpxs2G_connectionMain",
			"connectionDetail": "Tpxs2G_connectionDetail",
			"errorActions": "Tpxs2G_errorActions",
			"skeletonDot": "Tpxs2G_skeletonDot",
			"confirmIconWrap": "Tpxs2G_confirmIconWrap",
			"toolbar": "Tpxs2G_toolbar",
			"sideError": "Tpxs2G_sideError",
			"segment": "Tpxs2G_segment",
			"spin": "Tpxs2G_spin",
			"skeletonLine": "Tpxs2G_skeletonLine",
			"formActions": "Tpxs2G_formActions",
			"connectionList": "Tpxs2G_connectionList",
			"body": "Tpxs2G_body",
			"primary": "Tpxs2G_primary",
			"browserBusy": "Tpxs2G_browserBusy",
			"skeletons": "Tpxs2G_skeletons",
			"formSub": "Tpxs2G_formSub",
			"header": "Tpxs2G_header",
			"input": "Tpxs2G_input",
			"browser": "Tpxs2G_browser",
			"toolButtonOn": "Tpxs2G_toolButtonOn",
			"errorText": "Tpxs2G_errorText",
			"sideEmpty": "Tpxs2G_sideEmpty",
			"badge": "Tpxs2G_badge",
			"headerText": "Tpxs2G_headerText",
			"confirmHead": "Tpxs2G_confirmHead",
			"connectionLabel": "Tpxs2G_connectionLabel",
			"connectionRemove": "Tpxs2G_connectionRemove",
			"skeletonLines": "Tpxs2G_skeletonLines",
			"errorTitle": "Tpxs2G_errorTitle",
			"formGrid": "Tpxs2G_formGrid",
			"toolButtonText": "Tpxs2G_toolButtonText",
			"feedback": "Tpxs2G_feedback"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\ZCodeProject\dsh-workspace-enhancement\src\client\side-workspaces.module.css.mjs
		const css = ".C1f8bG_action,.C1f8bG_panel{--dswsw-accent:var(--color-primary,var(--accent,var(--primary,#4a6cf7)));--dswsw-accent-fg:#fff;--dswsw-surface:var(--color-bg-elevated,var(--background,var(--card,#17181c)));--dswsw-fg:var(--color-fg,var(--foreground,#e8e9ec));--dswsw-danger:var(--color-danger,var(--destructive,#e5534b));--dswsw-surface-2:color-mix(in srgb, var(--dswsw-fg) 3%, var(--dswsw-surface));--dswsw-surface-3:color-mix(in srgb, var(--dswsw-fg) 7%, var(--dswsw-surface));--dswsw-surface-inset:color-mix(in srgb, black 10%, var(--dswsw-surface));--dswsw-line:color-mix(in srgb, var(--dswsw-fg) 8%, var(--dswsw-surface));--dswsw-border:color-mix(in srgb, var(--dswsw-fg) 14%, var(--dswsw-surface));--dswsw-border-strong:color-mix(in srgb, var(--dswsw-fg) 26%, var(--dswsw-surface));--dswsw-fg-muted:color-mix(in srgb, var(--dswsw-fg) 65%, var(--dswsw-surface));--dswsw-fg-subtle:color-mix(in srgb, var(--dswsw-fg) 38%, var(--dswsw-surface));--dswsw-accent-soft:color-mix(in srgb, var(--dswsw-accent) 13%, var(--dswsw-surface));--dswsw-danger-soft:color-mix(in srgb, var(--dswsw-danger) 12%, var(--dswsw-surface));--dswsw-danger-text:color-mix(in srgb, var(--dswsw-danger) 55%, var(--dswsw-fg));--dswsw-scrim:#090a0d94;--dswsw-shadow:0 24px 64px #00000080}@media (prefers-color-scheme:light){.C1f8bG_action,.C1f8bG_panel{--dswsw-accent:var(--color-primary,var(--accent,var(--primary,#3b5bdb)));--dswsw-surface:var(--color-bg-elevated,var(--background,var(--card,#fff)));--dswsw-fg:var(--color-fg,var(--foreground,#21242a));--dswsw-danger:var(--color-danger,var(--destructive,#c9352f));--dswsw-surface-2:color-mix(in srgb, var(--dswsw-fg) 3%, var(--dswsw-surface));--dswsw-surface-3:color-mix(in srgb, var(--dswsw-fg) 7%, var(--dswsw-surface));--dswsw-surface-inset:color-mix(in srgb, black 6%, var(--dswsw-surface));--dswsw-line:color-mix(in srgb, var(--dswsw-fg) 8%, var(--dswsw-surface));--dswsw-border:color-mix(in srgb, var(--dswsw-fg) 14%, var(--dswsw-surface));--dswsw-border-strong:color-mix(in srgb, var(--dswsw-fg) 26%, var(--dswsw-surface));--dswsw-fg-muted:color-mix(in srgb, var(--dswsw-fg) 65%, var(--dswsw-surface));--dswsw-fg-subtle:color-mix(in srgb, var(--dswsw-fg) 38%, var(--dswsw-surface));--dswsw-accent-soft:color-mix(in srgb, var(--dswsw-accent) 11%, var(--dswsw-surface));--dswsw-danger-soft:color-mix(in srgb, var(--dswsw-danger) 10%, var(--dswsw-surface));--dswsw-danger-text:color-mix(in srgb, var(--dswsw-danger) 55%, var(--dswsw-fg));--dswsw-scrim:#0f111557;--dswsw-shadow:0 24px 64px #0f111533}}.C1f8bG_action{border:1px solid var(--dswsw-border);background:var(--dswsw-surface);color:var(--dswsw-fg);cursor:pointer;white-space:nowrap;border-radius:6px;align-items:center;gap:5px;padding:4px 10px;font-family:inherit;font-size:12px;display:inline-flex}.C1f8bG_action:hover{background:var(--dswsw-surface-3);border-color:var(--dswsw-border-strong)}.C1f8bG_action svg{flex:none}.C1f8bG_panel{z-index:1000;background:var(--dswsw-scrim);font-family:var(--font-sans,ui-sans-serif, system-ui, -apple-system, \"Segoe UI\", Roboto, \"PingFang SC\", \"Microsoft YaHei\", sans-serif);justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;inset:0}.C1f8bG_panel button,.C1f8bG_panel input,.C1f8bG_panel select{font-family:inherit}.C1f8bG_panel :focus-visible{outline:2px solid var(--dswsw-accent);outline-offset:1px}.C1f8bG_card{border:1px solid var(--dswsw-border);background:var(--dswsw-surface);width:560px;max-width:92vw;max-height:86vh;color:var(--dswsw-fg);box-shadow:var(--dswsw-shadow);border-radius:12px;flex-direction:column;gap:10px;padding:16px;font-size:13px;display:flex;overflow:auto}.C1f8bG_header{justify-content:space-between;align-items:center;gap:10px;display:flex}.C1f8bG_title{font-size:14px;font-weight:600}.C1f8bG_error{color:var(--dswsw-danger-text);overflow-wrap:anywhere;font-size:12px;line-height:1.45}.C1f8bG_list{flex-direction:column;gap:6px;max-height:240px;display:flex;overflow:auto}.C1f8bG_loading,.C1f8bG_empty{color:var(--dswsw-fg-muted);font-size:12px}.C1f8bG_empty{line-height:1.55}.C1f8bG_row{border:1px solid var(--dswsw-border);background:var(--dswsw-surface-2);border-radius:7px;align-items:center;gap:8px;padding:6px 8px;display:flex}.C1f8bG_rowIcon{color:var(--dswsw-fg-muted);flex:none}.C1f8bG_itemLabel{text-overflow:ellipsis;white-space:nowrap;flex:none;max-width:180px;font-size:12px;font-weight:600;overflow:hidden}.C1f8bG_rowPath{text-overflow:ellipsis;white-space:nowrap;max-width:180px;color:var(--dswsw-fg-muted);flex:none;font-size:11px;overflow:hidden}.C1f8bG_row .C1f8bG_input{flex:auto;width:auto;min-width:0}.C1f8bG_renameButton{border:1px solid var(--dswsw-border);color:var(--dswsw-fg-muted);cursor:pointer;white-space:nowrap;background:0 0;border-radius:6px;flex:none;padding:3px 8px;font-size:11.5px}.C1f8bG_renameButton:hover{background:var(--dswsw-surface-3);border-color:var(--dswsw-border-strong);color:var(--dswsw-fg)}.C1f8bG_form{border-top:1px solid var(--dswsw-line);flex-direction:column;gap:8px;padding-top:10px;display:flex}.C1f8bG_segment{border:1px solid var(--dswsw-line);background:var(--dswsw-surface-inset);border-radius:9px;gap:3px;width:fit-content;padding:3px;display:inline-flex}.C1f8bG_segmentButton{color:var(--dswsw-fg-muted);cursor:pointer;background:0 0;border:none;border-radius:6px;align-items:center;gap:6px;padding:4px 14px;font-size:12.5px;font-weight:500;display:inline-flex}.C1f8bG_segmentButton:hover:not(.C1f8bG_segmentButtonOn):not(:disabled){color:var(--dswsw-fg)}.C1f8bG_segmentButtonOn{background:var(--dswsw-surface-3);color:var(--dswsw-fg);box-shadow:inset 0 0 0 1px var(--dswsw-border-strong)}.C1f8bG_segmentButton:disabled{opacity:.55;cursor:default}.C1f8bG_fieldRow{gap:8px;display:flex}.C1f8bG_fieldRow .C1f8bG_input{flex:auto;width:auto;min-width:0}.C1f8bG_input{box-sizing:border-box;border:1px solid var(--dswsw-border);background:var(--dswsw-surface-inset);width:100%;color:var(--dswsw-fg);border-radius:7px;outline:none;padding:6px 9px;font-size:12.5px}.C1f8bG_input::placeholder{color:var(--dswsw-fg-subtle)}.C1f8bG_input:focus{border-color:var(--dswsw-accent);box-shadow:0 0 0 3px var(--dswsw-accent-soft)}.C1f8bG_select{border:1px solid var(--dswsw-border);background:var(--dswsw-surface-inset);min-width:72px;color:var(--dswsw-fg);border-radius:6px;outline:none;flex:none;padding:5px 6px;font-size:12px}.C1f8bG_select:focus{border-color:var(--dswsw-accent);box-shadow:0 0 0 3px var(--dswsw-accent-soft)}.C1f8bG_selectWide{width:100%}.C1f8bG_button{border:1px solid var(--dswsw-border);color:var(--dswsw-fg);cursor:pointer;white-space:nowrap;background:0 0;border-radius:7px;flex:none;justify-content:center;align-items:center;gap:6px;padding:5px 13px;font-size:12.5px;font-weight:500;line-height:1.4;display:inline-flex}.C1f8bG_button svg{flex:none}.C1f8bG_button:hover:not(:disabled){background:var(--dswsw-surface-3);border-color:var(--dswsw-border-strong)}.C1f8bG_primary{background:var(--dswsw-accent);border-color:var(--dswsw-accent);color:var(--dswsw-accent-fg)}.C1f8bG_primary:hover:not(:disabled){background:color-mix(in srgb, var(--dswsw-accent) 85%, #fff);border-color:color-mix(in srgb, var(--dswsw-accent) 85%, #fff)}.C1f8bG_button:disabled{opacity:.5;cursor:default}.C1f8bG_iconButton{width:28px;height:28px;color:var(--dswsw-fg-muted);cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;justify-content:center;align-items:center;display:inline-flex}.C1f8bG_iconButton:hover:not(:disabled){background:var(--dswsw-surface-3);color:var(--dswsw-fg)}.C1f8bG_iconButton.C1f8bG_danger{color:var(--dswsw-danger-text)}.C1f8bG_iconButton.C1f8bG_danger:hover{background:var(--dswsw-danger-soft);color:var(--dswsw-danger-text)}.C1f8bG_iconButton:disabled{opacity:.45;cursor:default}@media (width<=640px){.C1f8bG_panel{padding:12px}.C1f8bG_card{max-height:calc(100vh - 24px)}}";
		...
		var side_workspaces_module_css_default = {
			"rowPath": "C1f8bG_rowPath",
			"button": "C1f8bG_button",
			"selectWide": "C1f8bG_selectWide",
			"segment": "C1f8bG_segment",
			"header": "C1f8bG_header",
			"iconButton": "C1f8bG_iconButton",
			"loading": "C1f8bG_loading",
			"form": "C1f8bG_form",
			"select": "C1f8bG_select",
			"title": "C1f8bG_title",
			"primary": "C1f8bG_primary",
			"card": "C1f8bG_card",
			"error": "C1f8bG_error",
			"list": "C1f8bG_list",
			"segmentButtonOn": "C1f8bG_segmentButtonOn",
			"fieldRow": "C1f8bG_fieldRow",
			"segmentButton": "C1f8bG_segmentButton",
			"renameButton": "C1f8bG_renameButton",
			"danger": "C1f8bG_danger",
			"action": "C1f8bG_action",
			"itemLabel": "C1f8bG_itemLabel",
			"empty": "C1f8bG_empty",
			"row": "C1f8bG_row",
			"panel": "C1f8bG_panel",
			"rowIcon": "C1f8bG_rowIcon",
			"input": "C1f8bG_input"
		};
		//#endregion
		...
		*/
		...
		function SideWorkspacesPanel(props) {
			...
			const [draftFs, setDraftFs] = (0, react.useState)("rw");
			const [draftExec, setDraftExec] = (0, react.useState)("on");
			...
			const refresh = () => {
				setBusy(true);
				setError("");
				Promise.all([injected.rpc("session.ws.list", { sessionId }), injected.rpc("machines.list", {})]).then(([listResult, machinesResult]) => {
							...
							children: [
								...
								items.map((item) => (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										(0, react_jsx_runtime.jsxs)("select", {
											className: side_workspaces_module_css_default.select,
											value: item.fs,
											onChange: (event) => updateSide(item.rootKey, { fs: event.target.value }),
											"aria-label": t("side.fs.label"),
											children: [(0, react_jsx_runtime.jsx)("option", {
												value: "rw",
												children: t("permission.rw")
											}), (0, react_jsx_runtime.jsx)("option", {
												value: "r",
												children: t("permission.r")
											})]
										}),
										(0, react_jsx_runtime.jsxs)("select", {
											className: side_workspaces_module_css_default.select,
											value: item.exec,
											onChange: (event) => updateSide(item.rootKey, { exec: event.target.value }),
											"aria-label": t("side.exec.label"),
											children: [(0, react_jsx_runtime.jsx)("option", {
												value: "on",
												children: t("permission.execOn")
											}), (0, react_jsx_runtime.jsx)("option", {
												value: "off",
												children: t("permission.execOff")
											})]
										}),
										(0, react_jsx_runtime.jsx)("button", {
											type: "button",
								...
								(0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										(0, react_jsx_runtime.jsxs)("select", {
											className: side_workspaces_module_css_default.select,
											value: draftFs,
											onChange: (event) => setDraftFs(event.target.value),
											"aria-label": t("side.fs.label"),
											children: [(0, react_jsx_runtime.jsx)("option", {
												value: "rw",
												children: t("permission.rw")
										...
										(0, react_jsx_runtime.jsxs)("select", {
											className: side_workspaces_module_css_default.select,
											value: draftExec,
											onChange: (event) => setDraftExec(event.target.value),
											"aria-label": t("side.exec.label"),
											children: [(0, react_jsx_runtime.jsx)("option", {
												value: "on",
												children: t("permission.execOn")
