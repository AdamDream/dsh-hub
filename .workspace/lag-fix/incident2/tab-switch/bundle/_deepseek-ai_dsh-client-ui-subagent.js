window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		/** Whole-window decode rate from the same sessionStats projection the stats strip reads. */
		function decodeTokensPerSecond(summary) {
		...
		function CatalogRows({ parentSessionId, currentSessionId, catalog, catalogs, summaries, expanded, level, now, openChild, refresh, toggleBranch, closeCatalog, t }) {
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				catalog.entries.map((entry) => {
					...
					const tps = decodeTokensPerSecond(summary);
					const speedMetric = tps === void 0 ? void 0 : `${formatTokensPerSecond(tps)} tok/s`;
					const durationMetric = durationMs === void 0 ? void 0 : {
						compact: formatDuration(durationMs, t),
						exact: formatExactDuration(durationMs, t)
					};
					const headMetric = [tokenMetric, speedMetric].filter((value) => value !== void 0).join(" · ");
					const metrics = [headMetric, durationMetric?.exact].filter((value) => value !== void 0 && value !== "").join(" · ");
					const open = () => {
						openChild({
							parentSessionId,
							...
							children: [knownLeaf ? reserveDisclosure && (0, react_jsx_runtime.jsx)("span", { className: SubagentHeaderLineage_module_css_default.disclosureSpace }) : (0, react_jsx_runtime.jsx)("button", {
								...
								children: [
									...
									metrics !== "" && (0, react_jsx_runtime.jsxs)("span", {
										...
										children: [headMetric !== "" && (0, react_jsx_runtime.jsx)("span", {
		...
		*/
		function SubagentReadOnlyComposer({ matched, t, useProjection }) {
			const oneShot = matched.reason === "one-shot";
			const stats = typeof useProjection === "function" ? useProjection("sessionStats") : void 0;
			const tps = stats === void 0 || stats.decodeMs <= 0 ? void 0 : stats.decodeTokens / (stats.decodeMs / 1e3);
			const speed = tps === void 0 ? void 0 : `${formatTokensPerSecond(tps)} tok/s`;
			return (0, react_jsx_runtime.jsxs)("div", {
				className: SubagentReadOnlyComposer_module_css_default.frame,
				role: "status",
				children: [(0, react_jsx_runtime.jsx)("strong", { children: t(oneShot ? "readonly.oneShot.title" : "readonly.title") }), (0, react_jsx_runtime.jsx)("span", { children: t(oneShot ? "readonly.oneShot.body" : "readonly.body") }), speed !== void 0 && (0, react_jsx_runtime.jsx)("span", { children: speed })]
			});
		}
		//#endregion
