window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		/** Render callbacks coalesced into one per animation frame (see scheduleThemeColorRefresh). */
		...
		/** Applies theme snapshots to the document; one instance per plugin fiber per document. */
