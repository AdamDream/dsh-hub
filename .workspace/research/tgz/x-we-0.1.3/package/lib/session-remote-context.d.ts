 ...
 */
export declare function sessionWorkspaceContextOf(context: {
    readonly scope?: object;
}, store?: () => SessionSideWorkspaceStore | undefined): SessionWorkspaceContext;
/**
 ...
 * @param store - the side-workspace store accessor (absent → no attachments).
 */
export declare function hasRemoteWorkspaceContext(context: {
    readonly scope?: object;
}, store?: () => SessionSideWorkspaceStore | undefined): boolean;
