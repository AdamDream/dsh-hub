...
import { createRemoteSpawnGate } from "./remote-approval-gate.js";
import { RemoteSandboxError } from "./remote-sandbox.js";
import { createRemoteSandboxFence, createRemoteSandboxTerminalGuard, } from "./remote-sandbox-fence.js";
...
export class SshSubprocessEngine {
    ...
    lazyTerminalGuard;
    disposing = false;
    constructor(ctx, gate, fence, terminalGuard) {
        this.ctx = ctx;
        this.gate = gate;
        this.fence = fence;
     ...
     */
    async runGate(argv, route, signal, terminal) {
