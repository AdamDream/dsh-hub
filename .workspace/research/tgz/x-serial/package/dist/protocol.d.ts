...
export type SerialConnectionStatus = 'disconnected' | 'opening' | 'connected' | 'closing' | 'error';
...
export type SerialEvent = SerialReceiveEvent | SerialTransmitEvent | SerialStateEvent | SerialMarkerEvent | SerialErrorEvent;
/** Versioned declaration that this Host supports cancellable snapshot waiting. */
export declare const SERIAL_WAIT_SNAPSHOT_CAPABILITY: "v1";
...
export declare class SerialRemoteError extends Error {
    readonly code: string;
...
export declare function decodeSendRequest(request: SerialSendRequest): Uint8Array;
export {};
