...
const COMMITTED_RENDERER_OUTPUTS = {
  ...
  'hero-dark.png': '3c3f3689a570cb959076b7a262f2980d10b42b4b92ae363282f892848fdc9836',
  'hero.png': '3c3f3689a570cb959076b7a262f2980d10b42b4b92ae363282f892848fdc9836',
  'social-card.png': '41475d4cfd7092ab5696025dbe3d5911d0745b2edfcde30de57789ccaac61278',
...
async function trackedPngNames(): Promise<string[]> {
  // The fork ships as a plain directory (no git metadata), so the tracked set
  // is the committed docs/assets content itself.
  const names = await readdir(new URL('../docs/assets/', import.meta.url))
...
describe('Parallel Side Branch sign contract', () => {
  ...
  it('uses the canonical component on all shared Side Chat identity surfaces', async () => {
    ...
    expect(surface.match(/<SideChatSign\b/g)).toHaveLength(2)
