...
b64=base64.b64encode(open(__import__('os').path.join(__import__('os').path.dirname(out) if False else '/home/CNS2026495165/dsh/.workspace/mmt-probe','probe.jpg'),'rb').read()).decode()
